...
public final class ActivityInfoBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton buttonCurrent;
  ...
  private ActivityInfoBinding(@NonNull ScrollView rootView, @NonNull MaterialButton buttonCurrent,
      @NonNull TextInputLayout decriptionError, @NonNull TextInputLayout itemError,
      @NonNull TextInputLayout nameError, @NonNull TextInputLayout phoneError,
  ...
  public static ActivityInfoBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.buttonCurrent;
      MaterialButton buttonCurrent = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityInfoBinding((ScrollView) rootView, buttonCurrent, decriptionError,
          itemError, nameError, phoneError, progressCircular, submit, textView, toolbar);
    }
