...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  private FragmentHistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView receiveRv) {
    this.rootView = rootView;
    this.progressBar = progressBar;
    this.receiveRv = receiveRv;
  }
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.receiveRv;
      RecyclerView receiveRv = ViewBindings.findChildViewById(rootView, id);
      if (receiveRv == null) {
        break missingId;
      }

      return new FragmentHistoryBinding((ConstraintLayout) rootView, progressBar, receiveRv);
    }
